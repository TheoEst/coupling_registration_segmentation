...
This code is a modified version of a code from Stergios Christodoulidis
for the article "Linear and deformable image registration with 3d convolutional neural networks"
in the journal "Image Analysis for Moving Organ, Breast, and Thoracic Images"
"""
